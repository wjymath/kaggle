...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        func = LogisticRegression(random_state=0, solver='liblinear', class_weight='balanced', penalty='l1', warm_start=False)
        # func = svm.NuSVC(kernel='rbf', gamma='scale')
        # func = svm.LinearSVC(penalty='l1', class_weight='balanced', dual=False, max_iter=10000)
        clf = RFE(func, n_features_to_select=110)
